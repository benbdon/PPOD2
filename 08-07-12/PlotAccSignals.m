        ...
        switch domain
            case 'timeDomain'
                if NAMIDDS > NDIDDS
                    ...
                    signal2 = handles.signalinfo.amiddCyc(:,NDIDDS+1:end);%local x signal for second accelerometer
                else
...
for i = 1:numAxes
    ...
    eval(['set(gcf,''CurrentAxes'',handles.signalAxes',num2str(axesOrder(i)),')'])
