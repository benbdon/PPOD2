...
maxharmonic = handles.mainGUIhandles.controllerinfo.maxharmonic;
set(handles.plottedfreqs,'string',mat2str(basefreq:basefreq:500))
set(handles.plottedfreqs,'string',['[',num2str(basefreq),':',num2str(basefreq),':500]'])
