...
% Last Modified by GUIDE v2.5 04-Mar-2009 12:36:37
...
handles.globalinfo.maxupdates = 10;
...
handles.daqinfo.num_processing_cycles = 30;
...
if ismember('nidaq',daqinfo.InstalledAdaptors)
    ...
    %handles.daqinfo.ai.Channel.SensorRange = [1.5, 3.5];
...
InitializePlatePlots_CustomReponse(handles)
