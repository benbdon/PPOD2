...
% Last Modified by GUIDE v2.5 12-Aug-2013 14:33:29
...
set(handles.cameraModeAO,'value',1)
...
if get(hObject,'value')
    set(handles.numTransientCycles,'string',10);
    set(handles.numCollectedCycles,'string',5);
    set(handles.numProcessingCycles,'string',25);
    set(handles.cyclesPerUpdate,'string','40')
    set(handles.timePerUpdate,'string',num2str(40*handles.signalinfo.T))
else
    set(handles.numTransientCycles,'string',3);
    set(handles.numCollectedCycles,'string',5);
    set(handles.numProcessingCycles,'string',3);
    set(handles.cyclesPerUpdate,'string','11')
    set(handles.timePerUpdate,'string',num2str(11*handles.signalinfo.T))
end
...
% Hint: get(hObject,'Value') returns toggle state of squareSequence
if get(hObject,'value')
    set(handles.sinkSourceSequence,'value',0)
    set(handles.samplerSequence,'value',0)
    
    set(handles.updatePlots,'value',0)
    
    handles.controllerinfo.numTransientCycles = 3;
    handles.controllerinfo.numCollectedCycles = 5;
    handles.controllerinfo.numProcessingCycles = 3;
    handles.controllerinfo.CyclesPerUpdate = 11;
    ...
    set(handles.signalPanel1,'visible','off')
    set(handles.controlSignalsPanel,'visible','off')
    
    set(handles.fieldAxes,'visible','on')
    
    guidata(hObject,handles)
else
    set(handles.signalPanel1,'visible','on')
...
% Hint: get(hObject,'Value') returns toggle state of sinkSourceSequence
if get(hObject,'value')
    set(handles.squareSequence,'value',0)
    set(handles.samplerSequence,'value',0)
...
% Hint: get(hObject,'Value') returns toggle state of samplerSequence
if get(hObject,'value')
    set(handles.squareSequence,'value',0)
    set(handles.sinkSourceSequence,'value',0)
