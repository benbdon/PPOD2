...
set(gcf,'CurrentAxes',handles.laserAxes)
...
switch domain
    case 'timeDomain'
        ...
        set(findobj('tag',tag{2}),'xdata',tCyc,'ydata',diCycACC) %update di from accelerometer
        set(findobj('tag',tag{3}),'xdata',[0 T],'ydata',[diCycAve diCycAve])%update average di reading from laser
