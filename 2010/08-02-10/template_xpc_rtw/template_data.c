...
Parameters_template template_P = {
  /*  PCIDAS160212_P1_Size : '<Root>/PCI-DAS1602 12 '
   */
  { 1.0, 1.0 },
  1.0,                                 /* PCIDAS160212_P1 : '<Root>/PCI-DAS1602 12 '
                                        */
   ...
   */
  { 1.0, 1.0 },
  0.002,                               /* PCIDAS160212_P7 : '<Root>/PCI-DAS1602 12 '
                                        */
  ...
  1.0,                                 /* PCIDAS160212_P9 : '<Root>/PCI-DAS1602 12 '
                                        */
  5.0,                                 /* SineWave_Amp : '<Root>/Sine Wave'
                                        */
  0.0,                                 /* SineWave_Bias : '<Root>/Sine Wave'
                                        */
  100.0,                               /* SineWave_Freq : '<Root>/Sine Wave'
                                        */
  1.9866933079506122E-001,             /* SineWave_Hsin : '<Root>/Sine Wave'
                                        */
  9.8006657784124163E-001,             /* SineWave_HCos : '<Root>/Sine Wave'
                                        */
  -1.9866933079506122E-001,            /* SineWave_PSin : '<Root>/Sine Wave'
                                        */
  9.8006657784124163E-001,             /* SineWave_PCos : '<Root>/Sine Wave'
                                        */

  /*  PCIDDA0812_P1_Size : '<Root>/PCI-DDA08 12 '
   */
  { 1.0, 1.0 },
  1.0,                                 /* PCIDDA0812_P1 : '<Root>/PCI-DDA08 12 '
                                        */

  /*  PCIDDA0812_P2_Size : '<Root>/PCI-DDA08 12 '
   */
  { 1.0, 1.0 },
  -10.0,                               /* PCIDDA0812_P2 : '<Root>/PCI-DDA08 12 '
                                        */

  /*  PCIDDA0812_P3_Size : '<Root>/PCI-DDA08 12 '
   */
  { 1.0, 1.0 },
  1.0,                                 /* PCIDDA0812_P3 : '<Root>/PCI-DDA08 12 '
                                        */

  /*  PCIDDA0812_P4_Size : '<Root>/PCI-DDA08 12 '
   */
  { 1.0, 1.0 },
  0.0,                                 /* PCIDDA0812_P4 : '<Root>/PCI-DDA08 12 '
                                        */

  /*  PCIDDA0812_P5_Size : '<Root>/PCI-DDA08 12 '
   */
  { 1.0, 1.0 },
  0.002,                               /* PCIDDA0812_P5 : '<Root>/PCI-DDA08 12 '
                                        */
