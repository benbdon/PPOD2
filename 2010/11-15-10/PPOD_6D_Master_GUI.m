...
% Last Modified by GUIDE v2.5 15-Nov-2010 19:35:31
...
set(handles.plottedHarmonics,'string',['[0:',num2str(max(10,max(handles.controllerinfo.uiHarmonics)*2)),']'],'enable','off')
...
answer = inputdlg({'New frequencies to add:';'Input acceleration amplitude:'},'Frequency Response Data Collection',[1],{'20';num2str(GdiddInputMag)});
