...
% Last Modified by GUIDE v2.5 18-Nov-2010 12:36:23
...
if isempty(answer)
    ...
    G_ui2amiddNew = zeros(NAMIDDS,NUIS,length(freqsNew),NOHPF);
...
switch get(hObject,'tag')
    ...
    case 'forceModeAI'
        ...
        handles.globalinfo.pmiddSignals2 = {'am1dd','am2dd'};
...
ViewG_didd_GUI(handles.globalinfo, handles.controllerinfo)
