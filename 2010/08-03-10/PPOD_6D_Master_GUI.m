...
% Last Modified by GUIDE v2.5 04-Aug-2010 08:05:44
...
initialF = min(F(F>=30));
if isempty(initialF)
    initialF = handles.controllerinfo.F(1);
end
handles.controllerinfo.controlledFreqs = initialF;%set of frequencies actively controlled
...
%signalinfo
handles.signalinfo.T = 1/initialF;%cycle time (period)
