...
% Last Modified by GUIDE v2.5 01-Dec-2010 10:52:09
...
uiInitialSignals = get(get(handles.uiInitialModeSelector,'selectedobject'),'tag');
...
switch desSignals
    case 'desSignals_Pdd'
        ...
        set(handles.uiInitial_user,'enable','off')
        set(handles.uiInitial_previous,'enable','on')
        set(handles.uiInitial_guess,'enable','on','value',1)
        set(handles.uiInitial_zero,'enable','on')
        set(handles.uiHarmonics,'enable','on')
        set(handles.useNonlinearHarmonicTerms,'enable','on')
        set(handles.F_ui,'enable','on')
...
switch get(hObject,'tag')
    case 'standardModeAI'
        ...
        handles.globalinfo.pmiddSignals = {'pm1ddx','pm1ddy','pm2ddx','pm2ddy','pm3ddx','pm3ddy','pm4ddx','pm4ddy','pm5ddx','pm5ddy','pm6ddx','pm6ddy'};%accelerations measured by accelerometers mounted around the plate
        ...
        handles.globalinfo.diSignals = {};%actuator position measured by laser sensor
        ...
        handles.calibrationinfo.T_F2W = T_F2W;
        handles.calibrationinfo.T_LS2W = T_LS2W;
    ...
    case 'forceModeAI'
        ...
        handles.globalinfo.pmiddSignals = {'pm1ddx','pm1ddy','pm2ddx','pm2ddy'};%accelerations measured by accelerometers mounted around the plate
