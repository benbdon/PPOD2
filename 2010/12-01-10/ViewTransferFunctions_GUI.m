...
magGmax = max(max(max(abs(squeeze(magG(outputInds,inputInds,:,:))))));
magGmax1 = max(max(max(abs(squeeze(magG(outputInds<=3,inputInds,:,:))))));
if numel(outputInds) > 3
    magGmax2 = max(max(max(abs(squeeze(magG(outputInds>3,inputInds,:,:))))));
else
    magGmax2 = magGmax1;
end
