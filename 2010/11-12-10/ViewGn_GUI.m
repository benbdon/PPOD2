...
% Last Modified by GUIDE v2.5 12-Aug-2010 13:34:07
...
set(handles.u1_2_plateAcc,'Value',1)
...
% --- Executes on button press in u3_2_actuatorAcc.
function u3_2_actuatorAcc_Callback(hObject, eventdata, handles)
% hObject    handle to u3_2_actuatorAcc (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of u3_2_actuatorAcc


% --- Executes on button press in u2_2_actuatorAcc.
function u2_2_actuatorAcc_Callback(hObject, eventdata, handles)
% hObject    handle to u2_2_actuatorAcc (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of u2_2_actuatorAcc


% --- Executes on button press in u1_2_actuatorAcc.
function u1_2_actuatorAcc_Callback(hObject, eventdata, handles)
% hObject    handle to u1_2_actuatorAcc (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of u1_2_actuatorAcc
