...
switch signals
    case 'plateAcc'
        accSignals = handles.globalinfo.PddSignals;
    ...
    case 'plateAccLocal'
        ...
        NPALS = numel(handles.globalinfo.pmiddSignals);
        accSignals = titletext(1:NPALS/2);
    ...
    case 'actuatorAcc'
        accSignals = handles.globalinfo.diddSignals;
