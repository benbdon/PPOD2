...
handles.controllerinfo.G_u2acc = zeros(6,6,1,1);%set of discrete transfer functions from u to xyzrpy plate acceleration
handles.controllerinfo.G_u2accLocal = zeros(6,6,1,1);%set of discrete transfer functions from u to plate accelerometers
