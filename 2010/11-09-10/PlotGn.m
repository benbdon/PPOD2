...
G_u2acc = mainGUIhandles.controllerinfo.G_u2acc_all;
Gn_mag = abs(G_u2acc);
Gn_phase = angle(G_u2acc);
G_u2accLocal = mainGUIhandles.controllerinfo.G_u2accLocal_all;
Gn_raw_mag = abs(G_u2accLocal);
Gn_raw_phase = angle(G_u2accLocal);
G_u2ddd = mainGUIhandles.controllerinfo.G_u2ddd_all;
