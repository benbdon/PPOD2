...
% Last Modified by GUIDE v2.5 04-Oct-2010 12:24:20
...
%flexureinfo
handles.flexureinfo.flexureFreqs = f1;
...
% --- Executes on button press in generateFreqResponseFlexure.
function generateFreqResponseFlexure_Callback(hObject, eventdata, handles)
% hObject    handle to generateFreqResponseFlexure (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of generateFreqResponseFlexure


% --- Executes on button press in viewFreqResponseFlexure.
function viewFreqResponseFlexure_Callback(hObject, eventdata, handles)
% hObject    handle to viewFreqResponseFlexure (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
