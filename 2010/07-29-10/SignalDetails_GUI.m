...
T = handles.mainGUIhandles.plateinfo.T;
f1 = sym(1/T);
controlledFreqs = handles.mainGUIhandles.controllerinfo.controlledFreqs;
set(handles.plottedfreqs,'string',['[',num2str(eval(f1)),':',num2str(eval(f1)),':',num2str(controlledFreqs(end)*3),']'])
