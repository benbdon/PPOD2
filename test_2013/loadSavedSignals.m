...
%pull out old signal data that shouldn't be changed (measured accelerations)
PddCyc = handles.signalinfo.PddCyc;
pmiddCyc = handles.signalinfo.pmiddCyc;
amiddCyc = handles.signalinfo.amiddCyc;
diddCyc = handles.signalinfo.diddCyc;
...
%restore old measured accelerations
handles.signalinfo.PddCyc = PddCyc;
handles.signalinfo.pmiddCyc = pmiddCyc;
handles.signalinfo.amiddCyc = amiddCyc;
handles.signalinfo.diddCyc = diddCyc;
