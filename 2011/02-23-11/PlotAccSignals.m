        ...
        switch domain
            case 'timeDomain'
                if NAMIDDS > NDIDDS
                    ...
                    signal2 = handles.signalinfo.amiddCyc(:,NDIDDS+1:2:end);%local x signal for second accelerometer
                    signal3 = handles.signalinfo.amiddCyc(:,NDIDDS+2:2:end);%local y signal for second accelerometer
                else
            ...
            case 'freqDomain'
                if NAMIDDS > NDIDDS
                    ...
                    signal2 = abs(fft(handles.signalinfo.amiddCyc(:,NDIDDS+1:2:end)))/samplesPerCycle*2;
                    signal3 = abs(fft(handles.signalinfo.amiddCyc(:,NDIDDS+2:2:end)))/samplesPerCycle*2;
                else
...
for i = 1:numAxes
    ...
    switch domain
        case 'timeDomain'
            ...
            set(findobj('tag',tag{2}),'xdata',tCyc,'ydata',signal2(:,i)) %update signal2
            set(findobj('tag',tag{3}),'xdata',tCyc,'ydata',signal3(:,i)) %update signal3
        ...
        case 'freqDomain'
            ...
            set(findobj('tag',tag{3}),'xdata',plottedFreqs,'ydata',signal3(plottedHarmonics+1,i)) %update signal2
