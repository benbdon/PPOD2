...
switch aiConfig
    case 'standardModeAI'
        ...
        handles.globalinfo.amiddSignals = {'am1ddy','am2ddy','am3ddy','am4ddy','am5ddy','am6ddy','am7ddx','am7ddy','am8ddx','am8ddy','am9ddx','am9ddy','am10ddx','am10ddy','am11ddx','am11ddy','am12ddx','am12ddy'};%accelerations measured by accelerometers on actuator shafts in their local x-y frames.  am1 through am6 are y channel of acceleromoter mounted for axial measurements.  am(i+6) is for nonaxial measures (so am7 goes with actuator 1, am8 with actuator 2, etc)
        ...
        handles.signalinfo.samplingFreq = 8000;%DAQ sampling rate (Hz)
