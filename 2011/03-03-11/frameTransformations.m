...
[NUIS NPMIDDS NPDDS NAMIDDS NDIDDS] = signalCounter(handles); %outputs number of signals
...
switch handles.globalinfo.aiConfig
    case 'standard'
        ...
        T_di2ami = zeros(NAMIDDS,NDIDDS);
        T_di2ami(1:NDIDDS, 1:NDIDDS) = eye(NDIDDS);
        T_di2ami(NDIDDS+1:end,:) = 0;
