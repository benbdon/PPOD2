...
while currentUpdate < maxUpdate
    ...
    switch handles.globalinfo.mode
        case 'PddControl'
            ...
            if get(handles.savedSignalsListbox,'value') ~= savedSignalVal
                ...
                waitForControlUntil = currentUpdate+1;%turns off controller for 1 cycle if user has selectedd new plate motion
            else
                waitForControlUntil = currentUpdate;
            end
    ...
    switch handles.globalinfo.mode
        case {'PddControl','diddControl','diddAddFreqs'}
            ...
            %motion)
            if waitForControlUntil == currentUpdate
